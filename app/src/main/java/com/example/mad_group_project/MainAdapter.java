...
//public class MainAdapter extends FirebaseRecyclerAdapter<FoodCart, MainAdapter.myViewHolder> {
//
//
...
//     * @param options
//     */
//    public MainAdapter(@NonNull @NotNull FirebaseRecyclerOptions<FoodCart> options) {
//        super(options);
//    }
//
//
...
//        holder.price.setText(model.getFinalPrice().toString());
...
//        //CircleImageView img;
//        ImageView img;
//        TextView name,price,date,TotalSpending,quantity;
//
//
